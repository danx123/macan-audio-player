...
from PyQt6.QtWidgets import (
    ...
    QComboBox # [BARU] Impor QComboBox untuk preset
)
...
class VisualizerWidget(QWidget):
    def __init__(self, parent=None):
        ...
        self.bars = [0] * 50 # Perbanyak jumlah bar untuk visualizer 5-band
        # [MODIFIKASI] Gunakan 5 band
...
# [MODIFIKASI] Kelas EqualizerDialog dirombak total
class EqualizerDialog(QDialog):
    equalizer_updated = pyqtSignal(dict)
    
    # [BARU] Definisikan preset untuk equalizer
    PRESETS = {
    ...
    def __init__(self, parent=None, initial_settings=None):
        ...
        # [BARU] Tambahkan ComboBox untuk preset
    ...
    def update_settings(self):
        ...
        # Jika pengguna mengubah manual, set preset ke "Custom" jika ada
        current_preset = self.preset_combo.currentText()
        if self.equalizer_settings != self.PRESETS.get(current_preset):
             # Cek apakah "Custom" sudah ada
...
class AudioPlayer(QMainWindow):
    def __init__(self):
        ...
        # [BARU] Aktifkan drop event untuk seluruh jendela
        ...
        # [MODIFIKASI] Gunakan struktur equalizer baru
        self.equalizer_settings = {'60Hz': 0, '310Hz': 0, '1KHz': 0, '6KHz': 0, '16KHz': 0}
    ...
    # --- [BARU] Metode untuk Drag & Drop ---
    def dragEnterEvent(self, event):
        # Cek apakah data yang di-drag berisi URL (file)
    ...
    def dropEvent(self, event):
        ...
        if urls:
            ...
            for url in urls:
                # Ambil path file lokal dari URL
                if url.isLocalFile():
                    file_path = url.toLocalFile()
                    # Cek apakah ini file (bukan folder) dan formatnya didukung
    ...
    def load_settings(self):
        ...
        # Pastikan key dari setting yang tersimpan cocok dengan yang sekarang
