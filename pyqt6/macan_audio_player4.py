# Nama file: macan_audio_player_pro_v3.py
# Jalankan dengan perintah: python macan_audio_player_pro_v3.py
#
...
#
# Perubahan:
# 1. Ditambahkan tombol "➕" untuk menambahkan folder ke playlist yang sudah ada (queue).
# 2. Ditambahkan tombol "Bersihkan Playlist" untuk menghapus semua lagu.
# 3. Tema warna diubah menjadi biru gelap (dark blue).
...
class VisualizerWidget(QWidget):
    ...
    def paintEvent(self, event):
        ...
        painter.fillRect(self.rect(), QColor("#161F2B"))
...
class AudioPlayer(QMainWindow):
    ...
    def setup_ui(self):
        ...
        # Tombol baru untuk menambahkan folder (append) dan membersihkan playlist
        self.add_folder_button = QPushButton("➕")
        self.add_folder_button.setToolTip("Tambahkan folder/lagu ke playlist")
        self.clear_playlist_button = QPushButton("Bersihkan Playlist")
        ...
        self.control_panel.addSpacing(20) # Spasi untuk memisahkan tombol kontrol
        self.control_panel.addWidget(self.add_folder_button)
        self.control_panel.addWidget(self.clear_playlist_button)
    ...
    def add_folder(self):
        ...
        Sekarang ini berfungsi sebagai "queue" atau antrean.
        """
        ...
        if folder_path:
            ...
            if new_tracks_count > 0:
                self.statusBar().showMessage(f"Ditambahkan {new_tracks_count} lagu ke playlist.")
                # Simpan playlist yang diperbarui
                self.settings.setValue("playlist", self.playlist)
            else:
                self.statusBar().showMessage("Tidak ada lagu baru yang ditambahkan.")
    
    def clear_playlist(self):
        """
        Membersihkan seluruh playlist dan menghentikan pemutaran.
        """
        self.player.stop()
        self.playlist.clear()
        self.playlist_widget.clear()
        self.current_index = -1
        self.track_info_label.setText("Playlist Kosong")
        self.visualizer_widget.stop()
