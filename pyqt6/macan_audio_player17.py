...
# [FITUR 3] Import modul khusus Windows untuk thumbnail toolbar
if sys.platform == 'win32':
    try:
        from PyQt6.QtWinExtras import QWinThumbnailToolBar, QWinThumbnailToolButton
...
# [FIX 2] Memperbarui Ikon Maximize dan Restore
SVG_ICONS = {
...
class AudioPlayer(QMainWindow):
    def __init__(self):
        ...
        # [FIX 1] Definisikan variabel untuk title bar area
        ...
        # [FITUR 3] Panggil fungsi setup untuk thumbnail toolbar
    ...
    def setup_ui(self):
        ...
        # [FIX 1] Gunakan widget khusus untuk title bar agar mudah dideteksi untuk dragging
        title_bar_layout = self.create_title_bar()
        self.title_bar_widget.setLayout(title_bar_layout)
        self.title_bar_widget.setFixedHeight(40) # Sesuaikan tinggi title bar
    ...
    def setup_thumbnail_toolbar(self):
        ...
        # Tombol Play/Pause
        self.play_pause_thumb_button = QWinThumbnailToolButton(self.thumb_bar)
        ...
        # Tombol Next
        self.next_thumb_button = QWinThumbnailToolButton(self.thumb_bar)
    ...
    def mousePressEvent(self, event):
        if event.button() == Qt.MouseButton.LeftButton:
            # [FIX 1] Logika drag diubah. Cek apakah kursor ada di dalam widget title bar
            # dan bukan di atas salah satu tombol kontrol.
    ...
    def play_pause_music(self):
        ...
        if self.player.playbackState() == QMediaPlayer.PlaybackState.PlayingState:
            ...
            # [FITUR 3] Update ikon di thumbnail
            if WINDOWS_EXTRAS_AVAILABLE:
                self.play_pause_thumb_button.setIcon(get_icon_from_svg(SVG_ICONS["play"]))
                self.play_pause_thumb_button.setToolTip("Putar")
        else:
    ...
    def clear_playlist(self):
        ...
        self.update_playlist_display()
        self.update_status_bar()
        # [FITUR 3] Update ikon di thumbnail saat playlist dibersihkan
        if WINDOWS_EXTRAS_AVAILABLE:
            self.play_pause_thumb_button.setIcon(get_icon_from_svg(SVG_ICONS["play"]))
            self.play_pause_thumb_button.setToolTip("Putar")
    ...
    def apply_stylesheet(self):
        ...
        # [FIX 2] Update ikon maximize/restore sesuai status window
        if self.isMaximized():
